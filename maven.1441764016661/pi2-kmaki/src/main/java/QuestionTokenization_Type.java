 ...
 * @generated */
public class QuestionTokenization_Type extends DocumentAnnotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (QuestionTokenization_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = QuestionTokenization_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new QuestionTokenization(addr, QuestionTokenization_Type.this);
  			   QuestionTokenization_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new QuestionTokenization(addr, QuestionTokenization_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = QuestionTokenization.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("QuestionTokenization");
  ...
  public int getTokens(int addr) {
      ...
      jcas.throwFeatMissing("tokens", "QuestionTokenization");
  ...
  public String getAnnotator(int addr) {
      ...
      jcas.throwFeatMissing("annotator", "QuestionTokenization");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public QuestionTokenization_Type(JCas jcas, Type casType) {
    super(jcas, casType);
